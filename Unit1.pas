...
Unit2.Form2.ParamGrid.Cells[5, 0]:='¹ âåòêè';
...
for i:=1 to StringGrid1.RowCount do Experts.Lines.Add('Ýêñïåðò '+IntToStr(i));
...
//else ShowMessage('Ìàêñèìàëüíîå êîëè÷åñòâî ïàðàìåòðîâ íà äàííûé ìîìåíò: 5.');
//RefreshNames(Sender);
end;
...
//else ShowMessage('Ìèíèìàëüíîå êîëè÷åñòâî ïàðàìåòðîâ íà äàííûé ìîìåíò: 2.');
//RefreshNames(Sender);
end;

procedure TForm1.BitBtn2Click(Sender: TObject);
begin
ShowMessage('Ïðîãðàììà ñòðîèò äåðåâî íà îñíîâå ââåä¸ííûõ äàííûõ è âûñ÷èòûâàåò âåðîÿòíîñòè ñîñòîÿíèé. Ïëàíèðóåòñÿ äîðàáîòêà è îáðàòíûé âûâîä. Àâòîð: Êóêëà Ä.Þ., ñïåöèàëüíî äëÿ ïðîôåññîðà, äîêòîðà ôèçèêî-ìàòåìàòè÷åñêèõ íàóê Çåëåíêîâà Ã.À.');
end;
